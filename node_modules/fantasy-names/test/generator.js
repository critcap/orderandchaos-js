...
describe('#generator', function() {
	it('Produces a single name with 0 arguments', () => generator().length.should.equal(1));
	it('Produces a single name with 1 arguments', () => generator('military').length.should.equal(1));
	it('Produces a single name with 2 arguments', () => generator('military', 'nato').length.should.equal(1));
	it('Produces a single name with 3 arguments', () => generator('military', 'nato', 1).length.should.equal(1));
	...
	it('Check each generator works', function() {
		const generators = {
			...
			"dragon_age": ["dwarfs","humans","qunaris"],
